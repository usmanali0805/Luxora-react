...
const Favourite = () => {
  ...
  return (
    <div className="text-black min-h-screen p-5 sm:p-10 flex flex-col">
      ...
      <button className="bg-[#95c3fe] sm:px-6 px-3 py-1 text-white rounded-sm sm:py-3 sm:text-2xl w-fit fixed bottom-4 right-5 hover:text-slate-200 hover:bg-[#032a5d] transition duration-150 cursor-pointer">
        <Link to={"/Checkout"}>
        Check Out
        </Link>
        </button>
